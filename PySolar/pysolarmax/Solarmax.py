...
def init_groupsCommands():
    groups = [
        ...
        # Stats by day
        {
            ...
            'cmds': ["DD00", "DD01", "DD02", "DD03", "DD04", "DD05", "DD06", "DD07", "DD08", "DD09",
                     "DD10", "DD11", "DD12", "DD13", "DD14", "DD15", ],
            'action': 'History'
        },
        {
            'group': 'Stats by day 2',
            'cmds': ["DD16", "DD17", "DD18", "DD19", "DD20", "DD21", "DD22", "DD23", "DD24", "DD25",
                     "DD26", "DD27", "DD28", "DD29", "DD30", ],
            'action': 'History'
        },
...
def main():
    ...
    parser.add_argument('-d', '--dbname', dest='dbFileName', action='store', help='Database filename',
                        default='Solarmax_data2.s3db')
    parser.add_argument('-a', '--action', dest='action', action='store', help='Action (Send a predefined list of commands)',
                        choices=['Realtime', 'Stats', 'History', 'Info', 'SetTime'], default='Info')

    parser.add_argument('-o', '--output', dest='output', action='store', help='Output (Output to screen or to database)',
                        choices=['Screen', 'Database'], default='Screen')
